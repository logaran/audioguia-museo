...
const ControlsBar = ({ currentArtwork, toggleLike, setShowLanguageSelector, selectedLanguage, cookies }) => {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 h-16 flex items-center justify-between bg-black bg-opacity-70 z-20 p-6">
      <div className="cursor-pointer" onClick={() => setShowLanguageSelector(true)}>
